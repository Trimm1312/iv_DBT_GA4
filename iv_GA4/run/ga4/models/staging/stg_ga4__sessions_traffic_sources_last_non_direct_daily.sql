    ...
    merge into `set-ga-reporting`.`iv_GA4`.`stg_ga4__sessions_traffic_sources_last_non_direct_daily` as DBT_INTERNAL_DEST
        using (
...
select * from join_last_non_direct_session_source) as DBT_INTERNAL_SOURCE
        on FALSE
