  ...
  create or replace view `set-ga-reporting`.`iv_GA4`.`stg_ga4__event_file_download`
  OPTIONS()
  as -- reference here: https://support.google.com/analytics/answer/9216061?hl=en&ref_topic=9756175
