  ...
  create or replace view `set-ga-reporting`.`iv_GA4`.`stg_ga4__event_video_complete`
  OPTIONS()
  as -- Defined as when the video ends. For embedded YouTube videos that have JS API support enabled. Collected by default via enhanced measurement.
