    ...
    merge into `set-ga-reporting`.`iv_GA4`.`dim_ga4__sessions_daily` as DBT_INTERNAL_DEST
        using (
...
-- Collapse 
select distinct * from join_session_properties) as DBT_INTERNAL_SOURCE
        on FALSE
    ...
    when not matched then insert
        (`stream_id`, `session_key`, `session_partition_key`, `session_partition_date`, `session_partition_start_timestamp`, `landing_page_path`, `landing_page_location`, `landing_page_hostname`, `referrer`, `geo_continent`, `geo_country`, `geo_region`, `geo_city`, `geo_sub_continent`, `geo_metro`, `platform`, `device_category`, `device_mobile_brand_name`, `device_mobile_model_name`, `device_mobile_marketing_name`, `device_mobile_os_hardware_model`, `device_operating_system`, `device_operating_system_version`, `device_vendor_id`, `device_advertising_id`, `device_language`, `device_is_limited_ad_tracking`, `device_time_zone_offset_seconds`, `device_browser`, `device_web_info_browser`, `device_web_info_browser_version`, `device_web_info_hostname`, `user_campaign`, `user_medium`, `user_source`, `session_source`, `session_medium`, `session_campaign`, `session_content`, `session_term`, `session_default_channel_grouping`, `session_source_category`, `last_non_direct_source`, `last_non_direct_medium`, `last_non_direct_campaign`, `last_non_direct_content`, `last_non_direct_term`, `last_non_direct_default_channel_grouping`, `last_non_direct_source_category`)
    values
        (`stream_id`, `session_key`, `session_partition_key`, `session_partition_date`, `session_partition_start_timestamp`, `landing_page_path`, `landing_page_location`, `landing_page_hostname`, `referrer`, `geo_continent`, `geo_country`, `geo_region`, `geo_city`, `geo_sub_continent`, `geo_metro`, `platform`, `device_category`, `device_mobile_brand_name`, `device_mobile_model_name`, `device_mobile_marketing_name`, `device_mobile_os_hardware_model`, `device_operating_system`, `device_operating_system_version`, `device_vendor_id`, `device_advertising_id`, `device_language`, `device_is_limited_ad_tracking`, `device_time_zone_offset_seconds`, `device_browser`, `device_web_info_browser`, `device_web_info_browser_version`, `device_web_info_hostname`, `user_campaign`, `user_medium`, `user_source`, `session_source`, `session_medium`, `session_campaign`, `session_content`, `session_term`, `session_default_channel_grouping`, `session_source_category`, `last_non_direct_source`, `last_non_direct_medium`, `last_non_direct_campaign`, `last_non_direct_content`, `last_non_direct_term`, `last_non_direct_default_channel_grouping`, `last_non_direct_source_category`)
